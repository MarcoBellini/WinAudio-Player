...
#define WA_VISUALIZATIONS_FREQUENCY_MIN				60.0f
#define WA_VISUALIZATIONS_FREQUENCY_MAX				16000.0f
#define WA_VISUALIZATIONS_SCALE_FACTOR				2.6f
#define WA_VISUALIZATIONS_MIN_SAMPLE				0.2f
#define WA_VISUALIZATIONS_FALLOFF_VELOCITY			1.2f 
